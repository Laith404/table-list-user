...
export default {
    ...
    deleteUserList() { // удалить user'а
            this.sortedPeople = this.sortedPeople.filter(i => i.id !== this.peopleModal.id);
            this.$store.commit('DELETE_PEOPLE', this.peopleModal);
    },
